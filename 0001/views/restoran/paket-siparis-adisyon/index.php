  ...
  <div class="row clearfix mx-0">
          ...
          <div class="table-responsive tblKomutlarKapsayici">
            <table class="table tblKomutlar">
              <tbody>
                ...
                <tr>
                  <td>
                    <button type="button" class="btn l-slategray btn-lg btnMusteriAdresiniDegistir" name="button">Müşteri Adresini Değiştir</button>
                  </td>
                </tr>
              </tbody>
            </table>
    ...
    <div class="col-lg-4 px-1 col-sm-9 col-xs-9">
      ...
      <div class="row">
          ...
          <div class="table-responsive">
            <table class="table tblMasaBilgileri">
              <tbody>
                ...
                <tr>
                  <td>
                    <strong>ADİSYON MÜŞTERİSİ: </strong>
                  </td>
                  <td colspan="3">
                    <p class="m-0 " id="spanMusteriAdiSoyadi">
                      <?php
                      echo "<span id=''>".$this->musteriBilgileri["musteri_adi_soyadi"]."</span>";
                      ?>
                    </p>
        ...
        <div class="col-lg-6">
          <button class="btn btn-lg g-bg-cgreen btnSiparisiYazdir btnOdemeVeKapat" name="button"><span class="zmdi zmdi-print"></span>  PAKET FİŞİ YAZDIR</button>
        </div>
        <div class="col-lg-6">
          <a href="<?php echo $this->yolHtml; ?>restoran/paket-servis" class="btn btn-lg g-bg-cgreen btnOdemeVeKapat" name="button"><span class="zmdi zmdi-save"></span>  KAYDET VE GERİ DÖN</a>
        </div>
      </div>
    </div>
    <div class="col-lg-2 px-1 col-sm-4 col-xs-3" >
      <div class="card">
        <div class="body">
    ...
    <div class="col-lg-4 px-1 col-sm-8 col-xs-9">
      <div class="card mb-0">
        <div class="body">
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <input type="number" class="form-control txtUrunAdedi" id="txtUrunAdedi" name="txtUrunAdedi" min="1" placeholder="Ürün Adedi" >
        </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="input-group demoMaskedInput">
            <input type="hidden" id="txtMusteriIdsi" value="<?php echo $this->musteriIdsi; ?>">
            <input type="hidden" name="txtAdisyonIdsi" value="<?php echo $this->adisyonIdsi; ?>">
            <input type="hidden" name="txtMasaIdsi" id="txtMasaIdsi" value="">
...
<div class="modal fade" id="modalMusteriAdresDegistir" tabindex="-1" role="dialog">
  <div class="modal-dialog modal-lg" role="document">
    <form id="frmMusteriAdresDegistir" method="post" action="">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="title" id="largeModalLabel">Müşterinin diğer adreslerini kullan</h4>
        </div>
        <input type="hidden" id="txtMusteriIdsi" value="<?php echo $this->musteriIdsi; ?>">
        <div class="modal-body">
          <table class="table tblMusteriAdresleri">
            <thead>
              <th>Adres <button type="button" class="btn btn-default btn-xs g-bg-cgreen btnMusteriYeniAdresEkle" data-toggle="modal" data-target="#modalMusteriYeniAdresEkle" name="button"><span class="zmdi zmdi-plus"></span> Yeni Adres Ekle</button> </th>
              <th>İşlem</th>
            </thead>
            <tbody>
...
<div class="modal fade" id="modalMusteriYeniAdresEkle" tabindex="-1" role="dialog">
  <div class="modal-dialog modal-lg" role="document">
    <form id="frmMusteriYeniAdresEkle" method="post" action="">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="title" id="largeModalLabel">Müşteriye yeni adres ekle</h4>
        </div>
        <input type="hidden" id="txtMusteriIdsi" name="txtMusteriIdsi" value="<?php echo $this->musteriIdsi; ?>">
        <div class="modal-body">
          <label for="">Müşteri Yeni Adresi</label>
          <div class="input-group demoMaskedInput">
            <span class="input-group-addon"><i class="zmdi zmdi-bookmark"></i></span>
            <input type="text" id="txtMusteriAdresi" name="txtMusteriAdresi" class="form-control" required placeholder="Müşteri yeni adresini giriniz">
          </div>
        </div>
        <div class="modal-footer">
          <button type="submit" class="btn btn-default btn-round waves-effect btnLoading">KAYDET</button>
...
<div class="modal fade" id="modalMasaDegistir" tabindex="-1" role="dialog">
  <div class="modal-dialog modal-lg" role="document">
    <form id="frmMasaDegistir" method="post" action="">
      <input type="hidden" name="txtMasaIdsi" required value="">
...
<script src="<?php echo $this->yolHtml ?>views/restoran/paket-siparis-adisyon/paket-siparis-adisyon.js"></script>
</body>
