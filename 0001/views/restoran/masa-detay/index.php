...
.spanKeyboard{
  font-size: 23px;position: absolute;right: 45px;
}
</style>
    ...
    <div class="col-lg-4 px-1 col-sm-9 col-xs-9">
      ...
      <div class="row">
        ...
        <div class="col-lg-6">
          ...
          <a href="<?php echo $this->yolHtml; ?>restoran/odeme/<?php echo $this->masaIdsi.",".$this->lokasyonIdsi; ?>" class="btn btn-lg g-bg-cgreen btnOdemeVeKapat <?php echo $this->disabled; ?>" style="font-size:1.2vw;white-space:normal" name="button"><span class="zmdi zmdi-money-box"></span>  ÖDEME İŞLEMLERİ</a>
        </div>
        <div class="col-lg-6">
          <a href="<?php echo $this->yolHtml; ?>restoran/masalar/<?php echo $this->lokasyonIdsi; ?>" onclick="" class="btn btn-lg bg-red btnOdemeVeKapat btnKapat" name="button"><span class="zmdi zmdi-close"></span> KAPAT</a>
        </div>
      </div>
    </div>
          ...
          <div class="table-responsive tblUrunKategorileriKapsayici">
            <table class="table tblUrunKategorileri">
              <tbody>
                <tr>
                  <td>
                    <input type="text" placeholder="Kategorilerde filtreleyin" class="form-control kategoriArama">
                  </td>
                  <td>
                    <span class="zmdi zmdi-keyboard spanKeyboard"></span>
                  </td>
                </tr>
                <?php
                if ($this->menuler) {
          ...
          <div class="table-responsive tblUrunlerKapsayici">
            <table class="table ">
              <tbody>
                <tr>
                  <td>
                    <input type="text" placeholder="Ürünlerde filtreleyin" class="form-control urunArama">
                  </td>
                  <td>
                    <span class="zmdi zmdi-keyboard spanKeyboard "></span>
                  </td>
                ...
                <tr class="trAltUrunGeri d-none" >
                  <td>
                    <button type="button" class="btn bg-red" id="btnAltUrunGeri" data-id="" name="button"> GERİ</button>
                  </td>
                  <td>
                    <button type="button" class="btn bg-default float-left" disabled data-id="" name="button"><span class="spanUstKategoriAdi"></span> </button>
                  </td>
                </tr>
              </tbody>
            </table>
            <div class="row tblUrunler m-0">
              <div class="col-lg-12">
                ...
                for ($a=0; $a < count($this->urunler); $a++) {
                  ...
                  if ($this->urunler[$a]["urunAltUrunBilgileri"]) {
                    if (count($this->urunler[$a]["urun_gorseli"]) > 0) {
                      ...
                      style="position:relative"
                      type="button" class="btn btn-lg btnAltUrunleriGoster d-none" name="button">
                      ...
                      echo
                      '<div class="col-lg-4">
                      <button id="'.$this->urunler[$a]["id"].'" kategori-id="'.$this->urunler[$a]["urun_kategori_idsi"].'" type="button" class="btn l-slategray btn-lg btnAltUrunleriGoster btnUrunAdiClass d-none" name="button">
                    ...
                    if (count($this->urunler[$a]["urun_gorseli"]) > 0) {
                      ...
                      kategori-id="'.$this->urunler[$a]["urun_kategori_idsi"].'"
                      bg="/local-assets/urunler/'.$this->urunler[$a]["urun_gorseli"][0].'"
                      type="button" class="btn btn-lg btnUrunAdi d-none"
                      name="button"><span class="urunAdi">'.$this->urunler[$a]["urun_adi"].'<span></button>
                      </div>';
                    }else {
                      echo
                      '<div class="col-lg-4">
                      <button id="'.$this->urunler[$a]["id"].'" kategori-id="'.$this->urunler[$a]["urun_kategori_idsi"].'" type="button" class="btn l-slategray btn-lg btnUrunAdi d-none" name="button">'.$this->urunler[$a]["urun_adi"].'</button>
                      </div>';
                    }
  ...
  <div class="modal-dialog modal-lg" role="document">
    <form id="frmRezervasyonKaldir" method="post" action="">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="alert alert-warning" style="pointer-events:none">
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="alert alert-warning text-center" style="pointer-events:none">
...
<script src="<?php echo $this->yolHtml ?>views/restoran/masa-detay/masa-detay.js"></script>
</body>
