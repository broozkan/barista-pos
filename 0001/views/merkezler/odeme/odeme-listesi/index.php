...
<body class="theme-blue">
    ...
    <div class="block-header">
      <div class="row">
        <div class="col-lg-7 col-md-6 col-sm-12">
          <h2 id="pageName">Ödemelerin Listesi</h2>
        </div>
        <div class="col-lg-5 col-md-6 col-sm-12">
          <ul class="breadcrumb float-md-right">
            ...
            <li class="breadcrumb-item active">Ödemelerin Listesi</li>
          </ul>
        </div>
      </div>
    </div>
            ...
            <div class="body">
              <div class="row clearfix">
                ...
                <div class="col-lg-5 col-md-5 col-xs-12 text-right">
                  ...
                  <a href="<?php echo $this->yolHtml; ?>odeme/odeme-ekle/" class="btn btn-neutral hidden-sm-down" data-toggle="tooltip" title="Yeni Ekle">
          ...
          <div class="card">
            <div class="body table-responsive">
              <table class="table table-hover m-b-0 c_list">
                ...
                <tbody >
                  <?php
                  for ($i=0; $i < count($this->odemeListesi); $i++) {
                    echo
                    "<tr id='".$this->odemeListesi[$i]["odemeId"]."'>
                    <td>
                    <div class='checkbox'>
                    ...
                    <td>
                      <p class='c_name'>".$this->odemeListesi[$i]["odemeKodu"]."</p>
                    </td>
                    <td>
                      <p class='c_name'>".$this->odemeListesi[$i]["odemeTarihi"]."</p>
                    </td>
                    <td>
                      <p class='c_name'>".$this->odemeListesi[$i]["odemeCariAdi"]."</p>
                    </td>
                    <td>
                      <p class='c_name'>".$this->odemeListesi[$i]["odemeTutari"]." ".$this->kurIsareti." </p>
                    </td>
                    <td>
                      <p class='c_name'>".$this->odemeListesi[$i]["odemeKasaAdi"]."</p>
                    </td>
                    <td>
                      <p class='c_name'>".$this->odemeListesi[$i]["odemeAciklamasi"]."</p>
                    </td>
                    <td>
                    ...
                    <li>
                    <a href='".$this->yolHtml."odeme/odeme-duzenle/".$this->odemeListesi[$i]["odemeId"]."' >Düzenle</a>
                    </li>
                    <li class='btnSil'>
                    <a>Sil</a>
                    </li>
  ...
  <div class="modal fade" id="modalYeniOdemeEkle" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
      <form id="frmYeniOdemeEkle" method="post" action="">
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="title" id="largeModalLabel">Yeni Odeme Ekle</h4>
          </div>
          <div class="modal-body">
            <label for="">Odeme Adı</label>
            <div class="input-group demoMaskedInput">
              <span class="input-group-addon"><i class="zmdi zmdi-account"></i></span>
              <input type="hidden" name="txtOdemeTabloAdi" value="<?php echo $this->searchTabloAdlari[2]; ?>">
              <input type="text" id="txtOdemeAdi" data-kolon-index="0" data-tablo-index="0" autocomplete="off" name="txtOdemeAdi" class="form-control dataSearch" required placeholder="Odeme adı giriniz">
  ...
  <script src="<?php echo $this->yolHtml ?>views/merkezler/odeme/odeme-listesi/odeme-listesi.js"></script>
