...
<body class="theme-blue">
    ...
    <div class="block-header">
      <div class="row">
        <div class="col-lg-7 col-md-6 col-sm-12">
          <h2 id="pageName">Stok Sayımı Yap</h2>
        </div>
        <div class="col-lg-5 col-md-6 col-sm-12">
          <ul class="breadcrumb float-md-right">
            ...
            <li class="breadcrumb-item active">Stok Sayımı Yap</li>
          </ul>
        </div>
      </div>
    </div>
            ...
            <div class="body">
              <div class="row clearfix">
                ...
                <div class="col-lg-5 col-md-5 col-xs-12 text-right">
                  ...
                  <a href="<?php echo $this->yolHtml; ?>stok/stok-urunu-ekle/" class="btn btn-neutral hidden-sm-down" data-toggle="tooltip" title="Yeni Ekle">
          ...
          <div class="card">
            <div class="body table-responsive">
              <table class="table table-hover m-b-0 c_list" >
                ...
                <tbody >
                  <?php
                  for ($i=0; $i < count($this->stokUrunListesi); $i++) {
                    echo
                    "<tr id='".$this->stokUrunListesi[$i]["stokUrunId"]."'>
                    <td>
                    <div class='checkbox'>
                    ...
                    <td>
                    <p class='c_name'>".$this->stokUrunListesi[$i]["stokUrunAdi"]."</p>
                    </td>
                    <td>
                      <input value='".$this->stokUrunListesi[$i]["stokUrunAdedi"]."' class='form-control txtStokUrunAdedi show-tick ms' required  />
                    </td>
                    <td>
                      <p class='c_name'>".$this->stokUrunListesi[$i]["stokUrunBirimi"]."</p>
                    </td>
                    <td>
                    <div class='btn-group hidden-sm-down' role='group'>
                    <div class='btn-group'>
                    <button type='button' class='btn btn-neutral btnLoading btnStokAdediKaydet' data-toggle='tooltip' title='Ürünün stok değerini kaydet'>
  ...
  <script src="<?php echo $this->yolHtml ?>views/merkezler/stok/stok-sayimi-yap/stok-sayimi-yap.js"></script>
