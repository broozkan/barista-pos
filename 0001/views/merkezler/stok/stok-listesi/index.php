...
<body class="theme-blue">
    ...
    <div class="block-header">
      <div class="row">
        <div class="col-lg-7 col-md-6 col-sm-12">
          <h2 id="pageName">Stok Ürünleri Listesi</h2>
        </div>
        <div class="col-lg-5 col-md-6 col-sm-12">
          <ul class="breadcrumb float-md-right">
            ...
            <li class="breadcrumb-item active">Stok Ürünleri Listesi</li>
          </ul>
        </div>
      </div>
    </div>
              ...
              <table class="table table-hover m-b-0 c_list">
                ...
                <tbody >
                  ...
                  for ($i=0; $i < count($this->stokUrunListesi); $i++) {
                    ...
                    <td>
                    <p class='c_name' style='color:".$this->stokUrunListesi[$i]["color"]."'>".$this->stokUrunListesi[$i]["stokUrunAdedi"]."</p>
                    </td>
                    <td>
                    ...
                    <li>
                    <a href='".$this->yolHtml."/stok/stok-urunu-duzenle/".$this->stokUrunListesi[$i]["stokUrunId"]."' >Düzenle</a>
                    </li>
                    <li class='btnSil'>
                    <a>Sil</a>
                    </li>
  ...
  <script src="<?php echo $this->yolHtml ?>views/merkezler/stok/stok-listesi/stok-listesi.js"></script>
