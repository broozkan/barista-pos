...
<body class="theme-blue">
    ...
    <div class="block-header">
      <div class="row">
        <div class="col-lg-7 col-md-6 col-sm-12">
          <h2 id="pageName">Tahsilatlarin Listesi</h2>
        </div>
        <div class="col-lg-5 col-md-6 col-sm-12">
          <ul class="breadcrumb float-md-right">
            ...
            <li class="breadcrumb-item active">Tahsilatların Listesi</li>
          </ul>
        </div>
      </div>
    </div>
            ...
            <div class="body">
              <div class="row clearfix">
                ...
                <div class="col-lg-5 col-md-5 col-xs-12 text-right">
                  ...
                  <a href="<?php echo $this->yolHtml; ?>tahsilat/tahsilat-ekle/" class="btn btn-neutral hidden-sm-down" data-toggle="tooltip" title="Yeni Ekle">
              ...
              <table class="table table-hover m-b-0 c_list">
                <thead>
                  <tr>
                    ...
                    <th>Tahsilat Cari Hesap</th>
                    <th>Tahsilat Tutarı</th>
                    <th>Tahsilat Kasası</th>
                ...
                <tbody >
                  <?php
                  for ($i=0; $i < count($this->tahsilatListesi); $i++) {
                    echo
                    "<tr id='".$this->tahsilatListesi[$i]["tahsilatId"]."'>
                    <td>
                    <div class='checkbox'>
                    ...
                    <td>
                      <p class='c_name'>".$this->tahsilatListesi[$i]["tahsilatKodu"]."</p>
                    </td>
                    <td>
                      <p class='c_name'>".$this->tahsilatListesi[$i]["tahsilatTarihi"]."</p>
                    </td>
                    <td>
                      <p class='c_name'>".$this->tahsilatListesi[$i]["tahsilatCariAdi"]."</p>
                    </td>
                    <td>
                      <p class='c_name'>".$this->tahsilatListesi[$i]["tahsilatTutari"]." ".$this->kurIsareti."</p>
                    </td>
                    <td>
                      <p class='c_name'>".$this->tahsilatListesi[$i]["tahsilatKasaAdi"]."</p>
                    </td>
                    <td>
                      <p class='c_name'>".$this->tahsilatListesi[$i]["tahsilatAciklamasi"]."</p>
                    </td>
                    <td>
                    ...
                    <li>
                    <a href='/tahsilat/tahsilat-duzenle/".$this->tahsilatListesi[$i]["tahsilatId"]."' >Düzenle</a>
                    </li>
                    <li class='btnSil'>
                    <a>Sil</a>
                    </li>
  ...
  <script src="<?php echo $this->yolHtml ?>views/merkezler/tahsilat/tahsilat-listesi/tahsilat-listesi.js"></script>
