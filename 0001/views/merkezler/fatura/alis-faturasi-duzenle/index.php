...
<body class="theme-blue">
  ...
  <section class="content contact">
    <div class="block-header">
      <div class="row">
        <div class="col-lg-7 col-md-6 col-sm-12">
          <h2 id="pageName">Alış Faturası Düzenle</h2>
        </div>
    ...
    <div class="container-fluid">
      <div class="row clearfix">
        <div class="col-lg-12">
          <div class="card">
            <div class="header">
              <h2><strong>Alış</strong> Faturası Düzenle</h2>
            </div>
            <div class="body">
              <form id="frmAlisFaturasiDuzenle" method="post">
                <div class="row">
                  <div class="col-md-6">
                    <label for="">Alış Faturası Kodu</label>
                    <div class="input-group demoMaskedInput">
                      <span class="input-group-addon"><i class="zmdi zmdi-bookmark"></i></span>
                      <input type="hidden" name="txtAlisFaturasiIdsi" id="txtAlisFaturasiIdsi" required value="<?php echo $this->faturaBilgileri["id"]; ?>">
                      <input type="text" id="txtAlisFaturasiKodu" value="<?php echo $this->faturaBilgileri["alis_faturasi_kodu"]; ?>" data-kolon-index="18" data-tablo-index="16" autocomplete="off" name="txtAlisFaturasiKodu" class="form-control dataSearch" required placeholder="Alış faturası kodu giriniz">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="input-group demoMaskedInput">
                      <span class="input-group-addon"><i class="zmdi zmdi-bookmark"></i></span>
                      <input type="text" value="<?php echo $this->faturaBilgileri["alis_faturasi_seri_numarasi"]; ?>" id="txtAlisFaturasiSeriNumarasi" autocomplete="off" name="txtAlisFaturasiSeriNumarasi" class="form-control" placeholder="Alış faturası seri numarası giriniz">
                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="input-group demoMaskedInput">
                      <span class="input-group-addon"><i class="zmdi zmdi-bookmark"></i></span>
                      <input type="date" value="<?php echo $this->faturaBilgileri["alis_faturasi_vade_tarihi"]; ?>" id="txtAlisFaturasiVadeTarihi" name="txtAlisFaturasiVadeTarihi" class="form-control" required>
                    </div>
                  </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="input-group demoMaskedInput">
                      ...
                      <input
                      type="text"
                      data-id="<?php echo $this->faturaBilgileri["alis_faturasi_cari_idsi"]; ?>"
                      value="<?php echo $this->faturaBilgileri["alis_faturasi_cari_adi"]; ?>"
                      id="txtAlisFaturasiCariIdsi"
                      data-kolon-index="12"
                      data-tablo-index="10"
                      autocomplete="off"
                      name="txtAlisFaturasiCariIdsi"
                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="input-group demoMaskedInput">
                      <select class="form-control ms show-tick select2" required name="txtAlisFaturasiKasaIdsi" id="txtAlisFaturasiKasaIdsi" data-id="<?php echo $this->faturaBilgileri["alis_faturasi_kasa_idsi"]; ?>">
                        <?php
                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="input-group demoMaskedInput">
                      <select class="form-control ms show-tick select2" required name="txtAlisFaturasiKurIdsi" id="txtAlisFaturasiKurIdsi" data-id="<?php echo $this->faturaBilgileri["alis_faturasi_kur_idsi"]; ?>">
                        <?php
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="input-group demoMaskedInput">
                      <textarea name="txtAlisFaturasiAciklamasi" id="txtAlisFaturasiAciklamasi" class="form-control" rows="2" cols="80" placeholder="Alış faturası açıklaması girebilirsiniz"><?php echo $this->faturaBilgileri["alis_faturasi_aciklamasi"]; ?></textarea>
                    </div>
                  </div>
                </div>
              </div>
                    ...
                    <div class="row">
                                ...
                                for ($i=0; $i < count($this->faturaUrunleriBilgileri); $i++) {
                                  ...
                                  '<tr class="trUrunler">
                                    <td>
                                      ...
                                      <td>
                                        <input type="text" value="'.$this->faturaUrunleriBilgileri[$i]["alis_faturasi_urun_adi"].'" data-id="'.$this->faturaUrunleriBilgileri[$i]["alis_faturasi_urun_idsi"].'" list="urunler'.$i.'" class="form-control txtAlisFaturasiUrunleriUrunAdi dataSearch faturaVerileriniGuncelle" required data-kolon-index="5" data-tablo-index="4">
                                        <datalist id="urunler'.$i.'" class="ulAlisFaturasiUrunleriUrunIsimleri">

                                        </datalist>
                                      </td>
                                      <td>
                                        <input type="number" step=".01" value="'.$this->faturaUrunleriBilgileri[$i]["alis_faturasi_urun_adedi"].'" class="form-control txtAlisFaturasiUrunleriUrunAdedi faturaVerileriniGuncelle" required value="1" min="1">
                                      </td>
                                      <td>
                                        <select data-id="'.$this->faturaUrunleriBilgileri[$i]["alis_faturasi_urun_birim_idsi"].'" class="form-control ms show-tick txtAlisFaturasiUrunleriUrunBirimIdsi faturaVerileriniGuncelle" required>';
                                      ...
                                      <td>
                                        <select data-id="'.$this->faturaUrunleriBilgileri[$i]["alis_faturasi_urun_vergi_idsi"].'" class="form-control ms show-tick txtAlisFaturasiUrunleriUrunVergiIdsi faturaVerileriniGuncelle" required>
                                      ...
                                      <td>
                                        <input type="number" value="'.$this->faturaUrunleriBilgileri[$i]["alis_faturasi_urun_alis_fiyati"].'" step=".01" class="form-control txtAlisFaturasiUrunleriUrunBirimFiyati faturaVerileriniGuncelle" required value="0" min="0">
                                      </td>
                                      <td>
                                        <input type="number" value="'.$this->faturaUrunleriBilgileri[$i]["alis_faturasi_urun_tutari"].'" step=".01" class="form-control txtAlisFaturasiUrunleriUrunTutari" required readonly value="0" min="0">
                                      </td>
                                    </tr>';
                                }
                              ?>
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-3 text-right">
                          <p class="m-b-0 p-3"><b>Ara Toplam:</b> <span id="spanAraToplam"><?php echo $this->faturaBilgileri["alis_faturasi_ara_toplami"]; ?> </span> <span class="spanKurIsareti"></span> </p>
                          <p class="m-b-0 p-3"><b>İskonto (%): </b> <input type="number" step=".01" value="<?php echo $this->faturaBilgileri["alis_faturasi_iskonto"]; ?>" class="form-control faturaVerileriniGuncelle" style="width:80px;float:right" name="txtAlisFaturasiIskonto" id="txtAlisFaturasiIskonto" min="0" required value="0"> </p>
                          <div id="vergiGruplari">
                            <?php
                              for ($i=0; $i < count($this->faturaUrunleriBilgileri); $i++) {
                                echo '<p class="m-b-0"><b>'.$this->faturaUrunleriBilgileri[$i]["vergi_adi"].': </b> '.$this->faturaUrunleriBilgileri[$i]["alis_faturasi_urun_vergi_miktari"].'</p>';
                              }
                            ?>
                          </div>
                          ...
                          // }
                          ?>
                          <h3 class="m-b-0 m-t-10"><span class="spanKurIsareti"></span> <span id="spanFaturaToplami"><?php echo $this->faturaBilgileri["alis_faturasi_tutari"]; ?></span> </h3>
                        </div>
                      </div>
                      <hr>
    ...
    <script src="<?php echo $this->yolHtml ?>views/merkezler/fatura/alis-faturasi-duzenle/alis-faturasi-duzenle.js"></script>
