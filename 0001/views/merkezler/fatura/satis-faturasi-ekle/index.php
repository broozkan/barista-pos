...
<body class="theme-blue">
  ...
  <section class="content contact">
    <div class="block-header">
      <div class="row">
        <div class="col-lg-7 col-md-6 col-sm-12">
          <h2 id="pageName">Satış Faturası Ekle</h2>
        </div>
        <div class="col-lg-5 col-md-6 col-sm-12">
          <ul class="breadcrumb float-md-right">
            ...
            <li class="breadcrumb-item active">Satış Faturası Ekle</li>
          </ul>
        </div>
      </div>
    </div>
    <div class="container-fluid">
      <div class="row clearfix">
        <div class="col-lg-12">
          <div class="card">
            <div class="header">
              <h2><strong>Yeni Satış</strong> Faturası</h2>
            </div>
            <div class="body">
              <form id="frmSatisFaturasiEkle" method="post">
                <div class="row">
                  <div class="col-md-6">
                    <label for="">Satış Faturası Kodu</label>
                    <div class="input-group demoMaskedInput">
                      <span class="input-group-addon"><i class="zmdi zmdi-bookmark"></i></span>
                      <input type="text" id="txtSatisFaturasiKodu" data-kolon-index="23" data-tablo-index="21" autocomplete="off" name="txtSatisFaturasiKodu" class="form-control dataSearch" required placeholder="Satış faturası kodu giriniz">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="input-group demoMaskedInput">
                      <span class="input-group-addon"><i class="zmdi zmdi-bookmark"></i></span>
                      <input type="text" id="txtSatisFaturasiSeriNumarasi" autocomplete="off" name="txtSatisFaturasiSeriNumarasi" class="form-control" placeholder="Satış faturası seri numarası giriniz">
                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="input-group demoMaskedInput">
                      <span class="input-group-addon"><i class="zmdi zmdi-bookmark"></i></span>
                      <input type="date" id="txtSatisFaturasiVadeTarihi" name="txtSatisFaturasiVadeTarihi" class="form-control" required>
                    </div>
                  </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="input-group demoMaskedInput">
                      <span class="input-group-addon"><i class="zmdi zmdi-bookmark"></i></span>
                      <input type="text" id="txtSatisFaturasiCariIdsi" data-kolon-index="12" data-tablo-index="10" autocomplete="off" name="txtSatisFaturasiCariIdsi" class="form-control dataSearch" required placeholder="Cari adı giriniz">
                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="input-group demoMaskedInput">
                      <select class="form-control ms show-tick select2" required name="txtSatisFaturasiKasaIdsi" id="txtSatisFaturasiKasaIdsi" data-id="<?php echo $this->birincilKasaIdsi; ?>">
                        <?php
                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="input-group demoMaskedInput">
                      <select class="form-control ms show-tick select2" required name="txtSatisFaturasiKurIdsi" id="txtSatisFaturasiKurIdsi" data-id="<?php echo $this->birincilKurIdsi; ?>">
                        <?php
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="input-group demoMaskedInput">
                      <textarea name="txtSatisFaturasiAciklamasi" id="txtSatisFaturasiAciklamasi" class="form-control" rows="2" cols="80" placeholder="Satış faturası açıklaması girebilirsiniz"></textarea>
                    </div>
                  </div>
                </div>
              </div>
                    ...
                    <div class="row">
                            ...
                            <tbody>
                              <tr class="trUrunler">
                                <td>
                                  ...
                                  <td>
                                    <input type="text" list="urunler1" class="form-control txtSatisFaturasiUrunleriUrunAdi dataSearch faturaVerileriniGuncelle" required data-kolon-index="5" data-tablo-index="4">
                                    <datalist id="urunler1" class="ulSatisFaturasiUrunleriUrunIsimleri">

                                    </datalist>
                                  </td>
                                  <td>
                                    <input type="number" step=".01" class="form-control txtSatisFaturasiUrunleriUrunAdedi faturaVerileriniGuncelle" required value="1" min="1">
                                  </td>
                                  <td>
                                    <select class="form-control ms show-tick txtSatisFaturasiUrunleriUrunBirimIdsi faturaVerileriniGuncelle" required>
                                      <?php
                                  ...
                                  <td>
                                    <select class="form-control ms show-tick txtSatisFaturasiUrunleriUrunVergiIdsi faturaVerileriniGuncelle" required>
                                  ...
                                  <td>
                                    <input type="number" step=".01" class="form-control txtSatisFaturasiUrunleriUrunBirimFiyati faturaVerileriniGuncelle" required value="0" min="0">
                                  </td>
                                  <td>
                                    <input type="number" step=".01" class="form-control txtSatisFaturasiUrunleriUrunTutari" required readonly value="0" min="0">
                                  </td>
                                </tr>
                                <tr>
                                  <td colspan="7">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-3 text-right">
                          ...
                          <p class="m-b-0 p-3"><b>İskonto (%): </b> <input type="number" step=".01" class="form-control faturaVerileriniGuncelle" style="width:80px;float:right" name="txtSatisFaturasiIskonto" id="txtSatisFaturasiIskonto" min="0" required value="0"> </p>
    ...
    <script src="<?php echo $this->yolHtml ?>views/merkezler/fatura/satis-faturasi-ekle/satis-faturasi-ekle.js"></script>
