...
<body class="theme-blue">
    ...
    <div class="block-header">
      <div class="row">
        <div class="col-lg-7 col-md-6 col-sm-12">
          <h2 id="pageName">Satış Faturaları</h2>
        </div>
        <div class="col-lg-5 col-md-6 col-sm-12">
          <ul class="breadcrumb float-md-right">
            ...
            <li class="breadcrumb-item active">Satış Faturaları</li>
          </ul>
        </div>
      </div>
    </div>
            ...
            <div class="body">
              <div class="row clearfix">
                ...
                <div class="col-lg-5 col-md-5 col-xs-12 text-right">
                  ...
                  <a href="<?php echo $this->yolHtml; ?>fatura/satis-faturasi-ekle/" class="btn btn-neutral hidden-sm-down" data-toggle="tooltip" title="Yeni Satış Faturası Ekle">
          ...
          <div class="card">
            <div class="body table-responsive">
              <table class="table table-hover m-b-0 c_list">
                ...
                <tbody >
                  <?php
                  for ($i=0; $i < count($this->satisFaturasiListesi); $i++) {
                    echo
                    "<tr id='".$this->satisFaturasiListesi[$i]["satisFaturasiId"]."'>
                    <td>
                    <div class='checkbox'>
                    ...
                    <td>
                    <p class='c_name'>".$this->satisFaturasiListesi[$i]["satisFaturasiKodu"]."</p>
                    </td>
                    <td>
                    <p class='c_name'>".$this->satisFaturasiListesi[$i]["satisFaturasiMusteriAdi"]."</p>
                    </td>
                    <td>
                    <p class='c_name'>".$this->satisFaturasiListesi[$i]["satisFaturasiVadeTarihi"]."</p>
                    </td>
                    <td>
                    <p class='c_name'>".$this->satisFaturasiListesi[$i]["satisFaturasiTutari"]." ".$this->satisFaturasiListesi[$i]["satisFaturasiKurIsareti"]."  </p>
                    </td>
                    <td>
                    <p class='c_name'>".$this->satisFaturasiListesi[$i]["satisFaturasiAciklamasi"]."</p>
                    </td>
                    <td>
                    ...
                    <li>
                    <a href='".$this->yolHtml."fatura/satis-faturasi-goruntule/".$this->satisFaturasiListesi[$i]["satisFaturasiId"]."' >Görüntüle</a>
                    </li>
                    <li>
                    <a href='".$this->yolHtml."fatura/satis-faturasi-duzenle/".$this->satisFaturasiListesi[$i]["satisFaturasiId"]."' >Düzenle</a>
                    </li>
                    <li class='btnSil'>
                    <a>Sil</a>
                    </li>
  ...
  <script src="<?php echo $this->yolHtml ?>views/merkezler/fatura/satis-faturalari/satis-faturalari.js"></script>
