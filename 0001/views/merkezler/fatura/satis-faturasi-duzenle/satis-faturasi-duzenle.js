...
$(document).ready(function () {
  $("#frmSatisFaturasiDuzenle").on("submit",function (e) {
    e.preventDefault();
    var formVerileri = $("form#frmSatisFaturasiDuzenle").serializeJSON();
    ...
    if (izin) {
      ...
      jQuery.ajax({
        type: "POST",
        url: ""+yolHtml+"fatura/satis-faturasi-duzenle",
        data: {satisFaturasiDuzenle:json},
        cache: false,
        beforeSend: function() {
