...
<body class="theme-blue">
      ...
      <div class="row clearfix">
        ...
        <div class="col-lg-4 col-md-12">
          <div class="card">
            ...
            <div class="body">
              <form action="" id="frmHasilatRaporu" method="post">
                <div class="row">
                  <div class="col-md-6">
            ...
            <div class="card">
              ...
              <div class="body">
                <div class="table-responsive">
                  <table class="table tblHasilatSatisRaporu">
                    <thead>
                      <th>Hasılat Adı</th>
  ...
  <script src="<?php echo $this->yolHtml; ?>views/merkezler/rapor/hasilat-raporu/hasilat-raporu.js"></script>
