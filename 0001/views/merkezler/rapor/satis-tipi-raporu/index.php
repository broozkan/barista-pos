...
<body class="theme-blue">
  ...
  <section class="content">
    <div class="block-header">
      <div class="row">
        <div class="col-lg-7 col-md-6 col-sm-12">
          <h2>Hasılat Raporu
            <small>Gelirlerinizin analizlerine buradan ulaşabilirsiniz</small>
          </h2>
        </div>
        <div class="col-lg-5 col-md-6 col-sm-12">
          <ul class="breadcrumb float-md-right">
            ...
            <li class="breadcrumb-item active">Hasılat Raporu</li>
          </ul>
        </div>
      </div>
    </div>
    <div class="container-fluid">
      <div class="row clearfix">
        ...
        <div class="col-lg-4 col-md-12">
          <div class="card">
            ...
            <div class="body">
              <form action="" id="frmSatisTipiRaporu" method="post">
                <div class="row">
                  <div class="col-md-6">
      ...
      <input type="hidden" id="txtKurIsareti" value="<?php echo $this->varsayilanKurIsareti; ?>">
        <div class="row clearfix d-none rowHasilatSatisRaporu">

          <div class="col-lg-6 col-md-12">
            <div class="card">
              <div class="header">
                <h2><strong>Hasılat Satış</strong> Raporu</h2>
              </div>
              <div class="body">
                <canvas id="hasilatChart" height="150"></canvas>
                <input type="hidden" id="txtVarsayilanKurIsareti" value="<?php echo $this->varsayilanKurIsareti; ?>">
              </div>
            </div>
          </div>
          <div class="col-lg-6 col-md-12">
            <div class="card">
              ...
              <div class="body">
                <div class="table-responsive">
                  <table class="table tblSatisTipiRaporu">
                    <thead>
                      <th>Hasılat Adı</th>
  ...
  <script src="<?php echo $this->yolHtml; ?>views/merkezler/rapor/satis-tipi-raporu/satis-tipi-raporu.js"></script>
