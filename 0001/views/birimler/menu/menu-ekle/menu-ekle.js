$(document).ready(function () {
  ...
  $("form#frmMenuEkle").on("submit",function (e) {
    e.preventDefault();
    ...
    var formVerileri = $("form#frmMenuEkle").serializeJSON();
    ...
    formData.append("menuEkle",json);

    jQuery.ajax({
      type: "POST",
      url: ""+yolHtml+"menu/menuEkle/",
      xhr: function() {
