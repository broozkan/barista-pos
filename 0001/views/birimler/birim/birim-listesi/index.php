...
<body class="theme-blue">
    ...
    <div class="block-header">
      <div class="row">
        <div class="col-lg-7 col-md-6 col-sm-12">
          <h2 id="pageName">Birimlerin Listesi</h2>
        </div>
        <div class="col-lg-5 col-md-6 col-sm-12">
          <ul class="breadcrumb float-md-right">
            ...
            <li class="breadcrumb-item active">Birimlerin Listesi</li>
          </ul>
        </div>
      </div>
    </div>
            ...
            <div class="body">
              <div class="row clearfix">
                ...
                <div class="col-lg-5 col-md-5 col-xs-12 text-right">
                  ...
                  <a href="<?php echo $this->yolHtml; ?>birim/birim-ekle/" class="btn btn-neutral hidden-sm-down" data-toggle="tooltip" title="Yeni Ekle">
          ...
          <div class="card">
            <div class="body table-responsive">
              <table class="table table-hover m-b-0 c_list">
                ...
                <tbody >
                  <?php
                  for ($i=0; $i < count($this->birimListesi); $i++) {
                    echo
                    "<tr id='".$this->birimListesi[$i]["birimId"]."'>
                    <td>
                    <div class='checkbox'>
                    ...
                    <td>
                      <p class='c_name'>".$this->birimListesi[$i]["birimAdi"]."</p>
                    </td>
                    <td>
                      <p class='c_name'>".$this->birimListesi[$i]["birimKisaltmasi"]."</p>
                    </td>
                    <td>
                    ...
                    <li>
                    <a href='".$this->yolHtml."birim/birim-duzenle/".$this->birimListesi[$i]["birimId"]."' >Düzenle</a>
                    </li>
                    <li class='btnSil'>
                    <a>Sil</a>
                    </li>
  ...
  <div class="modal fade" id="modalYeniBirimEkle" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
      <form id="frmYeniBirimEkle" method="post" action="">
        <div class="modal-content">
          <div class="modal-header">
          ...
          <div class="modal-body">
            ...
            <div class="input-group demoMaskedInput">
              ...
              <input type="hidden" name="txtBirimTabloAdi" value="<?php echo $this->searchTabloAdlari[2]; ?>">
              <input type="text" id="txtBirimAdi" data-kolon-index="0" data-tablo-index="0" autocomplete="off" name="txtBirimAdi" class="form-control dataSearch" required placeholder="Birim adı giriniz">
  ...
  <script src="<?php echo $this->yolHtml ?>views/birimler/birim/birim-listesi/birim-listesi.js"></script>
