...
<body class="theme-blue">
    ...
    <div class="block-header">
      <div class="row">
        <div class="col-lg-7 col-md-6 col-sm-12">
          <h2 id="pageName">Lokasyonların Listesi</h2>
        </div>
        <div class="col-lg-5 col-md-6 col-sm-12">
          <ul class="breadcrumb float-md-right">
            <li class="breadcrumb-item"><a href="<?php echo $this->yolHtml; ?>"><i class="zmdi zmdi-home"></i> Anasayfa</a></li>
            <li class="breadcrumb-item"><a href="javascript:void(0);">Lokasyonler</a></li>
            <li class="breadcrumb-item active">Lokasyonlerin Listesi</li>
          </ul>
        </div>
      </div>
    </div>
            ...
            <div class="body">
              <div class="row clearfix">
                ...
                <div class="col-lg-5 col-md-5 col-xs-12 text-right">
                  ...
                  <a href="<?php echo $this->yolHtml; ?>lokasyon/lokasyon-ekle/" class="btn btn-neutral hidden-sm-down" data-toggle="tooltip" title="Yeni Ekle">
          ...
          <div class="card">
            <div class="body table-responsive">
              <table class="table table-hover m-b-0 c_list">
                ...
                <tbody >
                  <?php
                  for ($i=0; $i < count($this->lokasyonListesi); $i++) {
                    echo
                    "<tr id='".$this->lokasyonListesi[$i]["lokasyonId"]."'>
                    <td>
                    <div class='checkbox'>
                    ...
                    <td>
                      <p class='c_name'>".$this->lokasyonListesi[$i]["lokasyonAdi"]."</p>
                    </td>
                    <td>
                      <p class='c_name'>".$this->lokasyonListesi[$i]["lokasyonKati"]."</p>
                    </td>
                    <td>
                    ...
                    <li>
                    <a href='".$this->yolHtml."lokasyon/lokasyon-duzenle/".$this->lokasyonListesi[$i]["lokasyonId"]."' >Düzenle</a>
                    </li>
                    <li class='btnSil'>
                    <a>Sil</a>
                    </li>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="input-group demoMaskedInput">
              ...
              <input type="hidden" name="txtLokasyonTabloAdi" value="<?php echo $this->searchTabloAdlari[2]; ?>">
              <input type="text" id="txtLokasyonAdi" data-kolon-index="0" data-tablo-index="0" autocomplete="off" name="txtLokasyonAdi" class="form-control dataSearch" required placeholder="Lokasyon adı giriniz">
  ...
  <script src="<?php echo $this->yolHtml ?>views/birimler/lokasyon/lokasyon-listesi/lokasyon-listesi.js"></script>
