...
<body class="theme-blue">
    ...
    <div class="block-header">
      <div class="row">
        <div class="col-lg-7 col-md-6 col-sm-12">
          <h2 id="pageName">Kurlarin Listesi</h2>
        </div>
        <div class="col-lg-5 col-md-6 col-sm-12">
          <ul class="breadcrumb float-md-right">
            ...
            <li class="breadcrumb-item active">Kurlarin Listesi</li>
          </ul>
        </div>
      </div>
    </div>
            ...
            <div class="body">
              <div class="row clearfix">
                ...
                <div class="col-lg-5 col-md-5 col-xs-12 text-right">
                  ...
                  <a href="<?php echo $this->yolHtml; ?>kur/kur-ekle/" class="btn btn-neutral hidden-sm-down" data-toggle="tooltip" title="Yeni Ekle">
              ...
              <table class="table table-hover m-b-0 c_list">
                <thead>
                  <tr>
                    <th>#</th>
                    <th>Kur Adı</th>
                    <th>Kur Kısaltması</th>
                    <th>Kur İşareti</th>
                    <th>Kur Aktivitesi</th>
                    <th class="thLast">İşlem</th>
                  </tr>
                </thead>
                <tbody >
                  <?php
                  for ($i=0; $i < count($this->kurListesi); $i++) {
                    echo
                    "<tr id='".$this->kurListesi[$i]["kurId"]."'>
                    <td>
                    <div class='checkbox'>
                    ...
                    <td>
                      <p class='c_name'>".$this->kurListesi[$i]["kurAdi"]."</p>
                    </td>
                    <td>
                      <p class='c_name'>".$this->kurListesi[$i]["kurKisaltmasi"]."</p>
                    </td>
                    <td>
                      <p class='c_name'>".$this->kurListesi[$i]["kurIsareti"]."</p>
                    </td>
                    <td>
                      <p class='c_name'>".$this->kurListesi[$i]["kurAktifMi"]."</p>
                    </td>
                    <td>
                    ...
                    <li>
                    <a href='".$this->yolHtml."kur/kur-duzenle/".$this->kurListesi[$i]["kurId"]."' >Düzenle</a>
                    </li>
                    <li class='btnSil'>
                    <a>Sil</a>
                    </li>
  ...
  <script src="<?php echo $this->yolHtml ?>views/birimler/kur/kur-listesi/kur-listesi.js"></script>
