...
<body class="theme-blue">
    ...
    <div class="block-header">
      <div class="row">
        <div class="col-lg-7 col-md-6 col-sm-12">
          <h2 id="pageName">Kasalarin Listesi</h2>
        </div>
        <div class="col-lg-5 col-md-6 col-sm-12">
          <ul class="breadcrumb float-md-right">
            ...
            <li class="breadcrumb-item active">Kasalarin Listesi</li>
          </ul>
        </div>
      </div>
    </div>
            ...
            <div class="body">
              <div class="row clearfix">
                ...
                <div class="col-lg-5 col-md-5 col-xs-12 text-right">
                  ...
                  <a href="<?php echo $this->yolHtml; ?>kasa/kasa-ekle/" class="btn btn-neutral hidden-sm-down" data-toggle="tooltip" title="Yeni Ekle">
              ...
              <table class="table table-hover m-b-0 c_list">
                <thead>
                  <tr>
                    ...
                    <th>Kasa Aktivitesi</th>
                    <th class="thLast">İşlem</th>
                  </tr>
                </thead>
                <tbody >
                  <?php
                  for ($i=0; $i < count($this->kasaListesi); $i++) {
                    echo
                    "<tr id='".$this->kasaListesi[$i]["kasaId"]."'>
                    <td>
                    <div class='checkbox'>
                    ...
                    <td>
                      <p class='c_name'>".$this->kasaListesi[$i]["kasaAdi"]."</p>
                    </td>
                    <td>
                      <p class='c_name'>".$this->kasaListesi[$i]["kasaAcilisBakiyesi"]."</p>
                    </td>
                    <td>
                      <p class='c_name'>".$this->kasaListesi[$i]["kasaBirincilKasaMi"]."</p>
                    </td>
                    <td>
                    ...
                    <li>
                    <a href='".$this->yolHtml."kasa/kasa-duzenle/".$this->kasaListesi[$i]["kasaId"]."' >Düzenle</a>
                    </li>
                    <li class='btnSil'>
                    <a>Sil</a>
                    </li>
  ...
  <div class="modal fade" id="modalYeniKasaEkle" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
      <form id="frmYeniKasaEkle" method="post" action="">
        <div class="modal-content">
          <div class="modal-header">
          ...
          <div class="modal-body">
            ...
            <div class="input-group demoMaskedInput">
              ...
              <input type="hidden" name="txtKasaTabloAdi" value="<?php echo $this->searchTabloAdlari[2]; ?>">
              <input type="text" id="txtKasaAdi" data-kolon-index="0" data-tablo-index="0" autocomplete="off" name="txtKasaAdi" class="form-control dataSearch" required placeholder="Kasa adı giriniz">
  ...
  <script src="<?php echo $this->yolHtml ?>views/birimler/kasa/kasa-listesi/kasa-listesi.js"></script>
