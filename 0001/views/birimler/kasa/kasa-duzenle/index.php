...
<body class="theme-blue">
    ...
    <div class="block-header">
      <div class="row">
        <div class="col-lg-7 col-md-6 col-sm-12">
          <h2 id="pageName" >Kasa Düzenle</h2>
        </div>
    ...
    <div class="container-fluid">
      ...
      <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12">
          <form id="frmKasaDuzenle" method="post" action="">
            <?php

              for ($i=0; $i < count($this->kasaBilgileri); $i++) {
                echo
                '<div class="card">
                  <div class="header">
                  ...
                  <div class="body formArea">
                    ...
                    <div class="input-group divSuggestion">
                      ...
                      <input type="text" value="'.$this->kasaBilgileri[$i]["kasaAdi"].'" id="'.$this->kasaBilgileri[$i]["kasaIdsi"].'" data-tablo-index="13" data-kolon-index="15" autocomplete="off" name="txtKasaAdi" class="form-control dataSearch txtKasaAdi" required placeholder="Kasa adını giriniz">
                    ...
                    <div class="input-group">
                      <span class="input-group-addon"><i class="zmdi zmdi-bookmark"></i></span>
                      <input type="number" step=".01" value="'.$this->kasaBilgileri[$i]["kasaAcilisBakiyesi"].'"  name="txtKasaAcilisBakiyesi" class="txtKasaAcilisBakiyesi form-control" placeholder="Kasa açılış bakiyesini giriniz">
                    </div>
                    ...
                    <div class="input-group divSuggestion">
                      <select class="form-control ms show-tick txtKasaBirincilKasaMi" data-id="'.$this->kasaBilgileri[$i]["kasaBirincilKasaMi"].'" name="txtKasaBirincilKasaMi" id="txtKasaBirincilKasaMi" required>
  ...
  <script src="<?php echo $this->yolHtml ?>views/birimler/kasa/kasa-duzenle/kasa-duzenle.js"></script>
</body>
