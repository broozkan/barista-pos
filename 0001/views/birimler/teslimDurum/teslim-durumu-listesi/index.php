...
<body class="theme-blue">
    ...
    <div class="block-header">
      <div class="row">
        <div class="col-lg-7 col-md-6 col-sm-12">
          <h2 id="pageName">Teslim Durumları Listesi</h2>
        </div>
        <div class="col-lg-5 col-md-6 col-sm-12">
          <ul class="breadcrumb float-md-right">
            ...
            <li class="breadcrumb-item active">Teslim Durumları Listesi</li>
          </ul>
        </div>
      </div>
    </div>
            ...
            <div class="body">
              <div class="row clearfix">
                ...
                <div class="col-lg-5 col-md-5 col-xs-12 text-right">
                  ...
                  <a href="<?php echo $this->yolHtml; ?>teslim-durum/teslim-durumu-ekle/" class="btn btn-neutral hidden-sm-down" data-toggle="tooltip" title="Yeni Ekle">
            ...
            <div class="body table-responsive">
              <table class="table table-hover m-b-0 c_list">
                <thead>
                  <tr>
                    <th>#</th>
                    <th>Teslim Durumu Adı</th>
                    <th>Teslim Durumu Rengi <span class="zmdi zmdi-help" data-toggle="tooltip" title="Durumun temsil edileceği renktir"></span> </th>
                    <th class="thLast">İşlem</th>
                  </tr>
                </thead>
                <tbody >
                  <?php
                  for ($i=0; $i < count($this->teslimDurumuListesi); $i++) {
                    echo
                    "<tr id='".$this->teslimDurumuListesi[$i]["teslimDurumuId"]."'>
                    <td>
                    <div class='checkbox'>
                    ...
                    <td>
                      <p class='c_name'>".$this->teslimDurumuListesi[$i]["teslimDurumuAdi"]."</p>
                    </td>
                    <td>
                      <button class='btn btn-xs' style='background-color:".$this->teslimDurumuListesi[$i]["teslimDurumuRengi"]."' disabled >".$this->teslimDurumuListesi[$i]["teslimDurumuRengi"]."</button>
                    </td>
                    <td>
                    ...
                    <li>
                    <a href='".$this->yolHtml."teslim-durum/teslim-durumu-duzenle/".$this->teslimDurumuListesi[$i]["teslimDurumuId"]."' >Düzenle</a>
                    </li>
                    <li class='btnSil'>
                    <a>Sil</a>
                    </li>
  ...
  <script src="<?php echo $this->yolHtml ?>views/birimler/teslimDurum/teslim-durumu-listesi/teslim-durumu-listesi.js"></script>
