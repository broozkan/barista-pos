...
<body class="theme-blue">
      ...
      <div class="row">
        ...
        <div class="col-lg-5 col-md-6 col-sm-12">
          <ul class="breadcrumb float-md-right">
            ...
            <li class="breadcrumb-item active">Depo Ekle</li>
          </ul>
        </div>
      </div>
    </div>
      ...
      <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12">
          <div class="card">
            ...
            <div class="body">
              <form id="frmDepoEkle" method="post" action="">
                <label for="email_address">Depo Adı</label>
                <div class="input-group divSuggestion">
                  <span class="input-group-addon"><i class="zmdi zmdi-bookmark"></i></span>
                  <input type="text" id="txtDepoAdi" data-tablo-index="12" data-kolon-index="14" autocomplete="off" name="txtDepoAdi" class="form-control dataSearch" required placeholder="Depo adını giriniz">
  ...
  <script src="<?php echo $this->yolHtml ?>views/birimler/depo/depo-ekle/depo-ekle.js"></script>
</body>
