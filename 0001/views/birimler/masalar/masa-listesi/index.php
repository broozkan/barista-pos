...
<body class="theme-blue">
    ...
    <div class="block-header">
      <div class="row">
        <div class="col-lg-7 col-md-6 col-sm-12">
          <h2 id="pageName">Masaların Listesi</h2>
        </div>
        <div class="col-lg-5 col-md-6 col-sm-12">
          <ul class="breadcrumb float-md-right">
            ...
            <li class="breadcrumb-item active">Masaların Listesi</li>
          </ul>
        </div>
      </div>
    </div>
            ...
            <div class="body">
              <div class="row clearfix">
                ...
                <div class="col-lg-5 col-md-5 col-xs-12 text-right">
                  ...
                  <a href="<?php echo $this->yolHtml; ?>masa/masa-ekle/" class="btn btn-neutral hidden-sm-down" data-toggle="tooltip" title="Yeni Ekle">
                  ...
                  <div class="col-lg-12 col-xs-12">
                    <div class="form-row">
                      <div class="form-group col-md-4">
                        <label for="inputEmail4"><b>Masa Lokasyonu</b></label>
                        <input type="hidden" name="p" value="<?php echo $this->aktifSayfaNumarasi; ?>">
                        <select class="form-control show-tick ms select2 slctMasaLokasyonu" data-id="<?php echo $this->filtreDegerleri[0]; ?>" name="masaLokasyonIdsi" id="slctMasaLokasyonu">
                          <option value="*">Tümü</option>
                          <?php
                            for ($i=0; $i < count($this->masaLokasyonBilgileri); $i++) {
                              echo "<option value=".$this->masaLokasyonBilgileri[$i]["lokasyonId"].">".$this->masaLokasyonBilgileri[$i]["lokasyonAdi"]."</option>";
                            }
                          ?>
                        </select>
                      </div>
          ...
          <div class="card">
            <div class="body table-responsive">
              <table class="table table-hover m-b-0 c_list">
                ...
                <tbody >
                  <?php
                  for ($i=0; $i < count($this->masaListesi); $i++) {
                    echo
                    "<tr id='".$this->masaListesi[$i]["masaId"]."'>
                    <td>
                    <div class='checkbox'>
                    ...
                    <td>
                    <p class='c_name'>".$this->masaListesi[$i]["masaAdi"]."</p>
                    </td>
                    <td>
                    <p class='c_name'>".$this->masaListesi[$i]["masaLokasyonAdi"]."</p>
                    </td>
                    <td>
                    ...
                    <li>
                    <a href='".$this->yolHtml."masa/masa-duzenle/".$this->masaListesi[$i]["masaId"]."' >Düzenle</a>
                    </li>
                    <li class='btnSil'>
                    <a>Sil</a>
                    </li>
  ...
  <script src="<?php echo $this->yolHtml ?>views/birimler/masalar/masa-listesi/masa-listesi.js"></script>
