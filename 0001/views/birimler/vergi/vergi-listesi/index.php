...
<body class="theme-blue">
    ...
    <div class="block-header">
      <div class="row">
        <div class="col-lg-7 col-md-6 col-sm-12">
          <h2 id="pageName">Vergilerin Listesi</h2>
        </div>
        <div class="col-lg-5 col-md-6 col-sm-12">
          <ul class="breadcrumb float-md-right">
            <li class="breadcrumb-item"><a href="<?php echo $this->yolHtml; ?>"><i class="zmdi zmdi-home"></i> Anasayfa</a></li>
            <li class="breadcrumb-item"><a href="javascript:void(0);">Vergiler</a></li>
            <li class="breadcrumb-item active">Vergilerin Listesi</li>
          </ul>
        </div>
      </div>
    </div>
            ...
            <div class="body">
              <div class="row clearfix">
                ...
                <div class="col-lg-5 col-md-5 col-xs-12 text-right">
                  ...
                  <a href="<?php echo $this->yolHtml; ?>vergi/vergi-ekle/" class="btn btn-neutral hidden-sm-down" data-toggle="tooltip" title="Yeni Ekle">
          ...
          <div class="card">
            <div class="body table-responsive">
              <table class="table table-hover m-b-0 c_list">
                ...
                <tbody >
                  <?php
                  for ($i=0; $i < count($this->vergiListesi); $i++) {
                    echo
                    "<tr id='".$this->vergiListesi[$i]["vergiId"]."'>
                    <td>
                    <div class='checkbox'>
                    ...
                    <td>
                      <p class='c_name'>".$this->vergiListesi[$i]["vergiAdi"]."</p>
                    </td>
                    <td>
                      <p class='c_name'>".$this->vergiListesi[$i]["vergiYuzdesi"]."</p>
                    </td>
                    <td>
                    ...
                    <li>
                    <a href='".$this->yolHtml."vergi/vergi-duzenle/".$this->vergiListesi[$i]["vergiId"]."' >Düzenle</a>
                    </li>
                    <li class='btnSil'>
                    <a>Sil</a>
                    </li>
  ...
  <div class="modal fade" id="modalYeniVergiEkle" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
      <form id="frmYeniVergiEkle" method="post" action="">
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="title" id="largeModalLabel">Yeni Vergi Ekle</h4>
          </div>
          <div class="modal-body">
            <label for="">Vergi Adı</label>
            <div class="input-group demoMaskedInput">
              <span class="input-group-addon"><i class="zmdi zmdi-account"></i></span>
              <input type="hidden" name="txtVergiTabloAdi" value="<?php echo $this->searchTabloAdlari[2]; ?>">
              <input type="text" id="txtVergiAdi" data-kolon-index="0" data-tablo-index="0" autocomplete="off" name="txtVergiAdi" class="form-control dataSearch" required placeholder="Vergi adı giriniz">
  ...
  <script src="<?php echo $this->yolHtml ?>views/birimler/vergi/vergi-listesi/vergi-listesi.js"></script>
