...
<body class="theme-blue">
    ...
    <div class="block-header">
      <div class="row">
        <div class="col-lg-7 col-md-6 col-sm-12">
          <h2 id="pageName">Kategorilerin Listesi</h2>
        </div>
        <div class="col-lg-5 col-md-6 col-sm-12">
          <ul class="breadcrumb float-md-right">
            ...
            <li class="breadcrumb-item active">Kategorilerin Listesi</li>
          </ul>
        </div>
      </div>
    </div>
            ...
            <div class="body">
              <div class="row clearfix">
                ...
                <div class="col-lg-5 col-md-5 col-xs-12 text-right">
                  ...
                  <a href="<?php echo $this->yolHtml; ?>kategori/kategori-ekle/" class="btn btn-neutral hidden-sm-down" data-toggle="tooltip" title="Yeni Ekle">
              ...
              <table class="table table-hover m-b-0 c_list">
                <thead>
                  <tr>
                    <th>#</th>
                    <th>Kategori Adı</th>
                    <th>Kategori Sıra Numarası <span class="zmdi zmdi-help" data-toggle="tooltip" title="Sipariş alma ekranlarında kategorilerin sıralanma sayısıdır. En küçük değere sahip kategori en üstte sergilenir"></span> </th>
                    <th class="thLast">İşlem</th>
                  </tr>
                </thead>
                <tbody >
                  <?php
                  for ($i=0; $i < count($this->kategoriListesi); $i++) {
                    echo
                    "<tr id='".$this->kategoriListesi[$i]["kategoriId"]."'>
                    <td>
                    <div class='checkbox'>
                    ...
                    <td>
                      <p class='c_name'>".$this->kategoriListesi[$i]["kategoriAdi"]."</p>
                    </td>
                    <td>
                      <p class='c_name'>".$this->kategoriListesi[$i]["kategoriSiraNumarasi"]."</p>
                    </td>
                    <td>
                    ...
                    <li>
                    <a href='".$this->yolHtml."kategori/kategori-duzenle/".$this->kategoriListesi[$i]["kategoriId"]."' >Düzenle</a>
                    </li>
                    <li class='btnSil'>
                    <a>Sil</a>
                    </li>
  ...
  <script src="<?php echo $this->yolHtml ?>views/birimler/kategori/kategori-listesi/kategori-listesi.js"></script>
