...
<body class="theme-blue">
    ...
    <div class="block-header">
      <div class="row">
        <div class="col-lg-7 col-md-6 col-sm-12">
          <h2 id="pageName">Ödeme Metodları Listesi</h2>
        </div>
        <div class="col-lg-5 col-md-6 col-sm-12">
          <ul class="breadcrumb float-md-right">
            ...
            <li class="breadcrumb-item active">Ödeme Metodları Listesi</li>
          </ul>
        </div>
      </div>
    </div>
            ...
            <div class="body">
              <div class="row clearfix">
                ...
                <div class="col-lg-5 col-md-5 col-xs-12 text-right">
                  ...
                  <a href="<?php echo $this->yolHtml; ?>odeme-metod/odeme-metod-ekle/" class="btn btn-neutral hidden-sm-down" data-toggle="tooltip" title="Yeni Ekle">
              ...
              <table class="table table-hover m-b-0 c_list">
                <thead>
                  <tr>
                    ...
                    <th>Ödeme Metodu Sırası <span class="zmdi zmdi-help" data-toggle="tooltip" title="Ödeme ekranında ödeme tiplerinin küçükten büyüğe doğru sıralanacağı sıradır."></span> </th>
                    <th>Ödeme Metodu Aktivitesi <span class="zmdi zmdi-help" data-toggle="tooltip" title="Ödeme seçeneğini pasif duruma alırsanız ödeme ekranında listelenmeyecektir."></span></th>
                    <th class="thLast">İşlem</th>
                  </tr>
                </thead>
                <tbody >
                  <?php
                  for ($i=0; $i < count($this->odemeMetodListesi); $i++) {
                    echo
                    "<tr id='".$this->odemeMetodListesi[$i]["odemeMetodId"]."'>
                    <td>
                    <div class='checkbox'>
                    ...
                    <td>
                      <p class='c_name'>".$this->odemeMetodListesi[$i]["odemeMetodAdi"]."</p>
                    </td>
                    <td>
                      <p class='c_name'>".$this->odemeMetodListesi[$i]["odemeMetodSiralamasi"]."</p>
                    </td>
                    <td>
                      <p class='c_name'>".$this->odemeMetodListesi[$i]["odemeMetodAktifMi"]."</p>
                    </td>
                    <td>
                    ...
                    <li>
                    <a href='".$this->yolHtml."odeme-metod/odeme-metod-duzenle/".$this->odemeMetodListesi[$i]["odemeMetodId"]."' >Düzenle</a>
                    </li>
                    <li class='btnSil'>
                    <a>Sil</a>
                    </li>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="input-group demoMaskedInput">
              ...
              <input type="hidden" name="txtKurTabloAdi" value="<?php echo $this->searchTabloAdlari[2]; ?>">
              <input type="text" id="txtKurAdi" data-kolon-index="0" data-tablo-index="0" autocomplete="off" name="txtKurAdi" class="form-control dataSearch" required placeholder="Kur adı giriniz">
  ...
  <script src="<?php echo $this->yolHtml ?>views/birimler/odemeMetod/odeme-metod-listesi/odeme-metod-listesi.js"></script>
