...
<body class="theme-blue">
    ...
    <div class="block-header">
      <div class="row">
        <div class="col-lg-7 col-md-6 col-sm-12">
          <h2 id="pageName">Statülerin Listesi</h2>
        </div>
        <div class="col-lg-5 col-md-6 col-sm-12">
          <ul class="breadcrumb float-md-right">
            <li class="breadcrumb-item"><a href="<?php echo $this->yolHtml; ?>"><i class="zmdi zmdi-home"></i> Anasayfa</a></li>
            <li class="breadcrumb-item"><a href="javascript:void(0);">Statüler</a></li>
            <li class="breadcrumb-item active">Statülerin Listesi</li>
          </ul>
        </div>
      </div>
    </div>
            ...
            <div class="body">
              <div class="row clearfix">
                ...
                <div class="col-lg-5 col-md-5 col-xs-12 text-right">
                  ...
                  <a href="<?php echo $this->yolHtml; ?>statu/statu-ekle/" class="btn btn-neutral hidden-sm-down" data-toggle="tooltip" title="Yeni Ekle">
          ...
          <div class="card">
            <div class="body table-responsive">
              <table class="table table-hover m-b-0 c_list">
                ...
                <tbody >
                  <?php
                  for ($i=0; $i < count($this->statuListesi); $i++) {
                    echo
                    "<tr id='".$this->statuListesi[$i]["statuId"]."'>
                    <td>
                    <div class='checkbox'>
                    ...
                    <td>
                      <p class='c_name'>".$this->statuListesi[$i]["statuAdi"]."</p>
                    </td>
                    <td>
                    ...
                    <li>
                    <a href='".$this->yolHtml."statu/statu-duzenle/".$this->statuListesi[$i]["statuId"]."' >Düzenle</a>
                    </li>
                    <li class='btnSil'>
                    <a>Sil</a>
                    </li>
  ...
  <div class="modal fade" id="modalYeniStatuEkle" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
      <form id="frmYeniStatuEkle" method="post" action="">
        <div class="modal-content">
          <div class="modal-header">
          ...
          <div class="modal-body">
            ...
            <div class="input-group demoMaskedInput">
              ...
              <input type="hidden" name="txtStatuTabloAdi" value="<?php echo $this->searchTabloAdlari[2]; ?>">
              <input type="text" id="txtStatuAdi" data-kolon-index="0" data-tablo-index="0" autocomplete="off" name="txtStatuAdi" class="form-control dataSearch" required placeholder="Statü adı giriniz">
  ...
  <script src="<?php echo $this->yolHtml ?>views/birimler/statu/statu-listesi/statu-listesi.js"></script>
