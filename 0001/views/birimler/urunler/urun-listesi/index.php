...
<body class="theme-blue">
    ...
    <div class="block-header">
      <div class="row">
        <div class="col-lg-7 col-md-6 col-sm-12">
          <h2 id="pageName">Ürünlerin Listesi</h2>
        </div>
        <div class="col-lg-5 col-md-6 col-sm-12">
          <ul class="breadcrumb float-md-right">
            ...
            <li class="breadcrumb-item active">Ürünlerin Listesi</li>
          </ul>
        </div>
      </div>
    </div>
            ...
            <div class="body">
              <div class="row clearfix">
                ...
                <div class="col-lg-5 col-md-5 col-xs-12 text-right">
                  ...
                  <a href="<?php echo $this->yolHtml; ?>urun/urun-ekle/" class="btn btn-neutral hidden-sm-down" data-toggle="tooltip" title="Yeni Ekle">
          ...
          <div class="card">
            <div class="body table-responsive">
              <table class="table table-hover m-b-0 c_list">
                ...
                <tbody >
                  <?php
                  for ($i=0; $i < count($this->urunListesi); $i++) {
                    echo
                    "<tr id='".$this->urunListesi[$i]["urunId"]."'>
                    <td>
                    <div class='checkbox'>
                    ...
                    <td>
                    <p class='c_name'>".$this->urunListesi[$i]["urunKodu"]."</p>
                    </td>
                    <td>
                    <p class='c_name'>".$this->urunListesi[$i]["urunAdi"]."</p>
                    </td>
                    <td>
                    <p class='c_name'>".$this->urunListesi[$i]["urunKategoriIdsi"]."</p>
                    </td>
                    <td>
                    ...
                    <li>
                    <a href='".$this->yolHtml."urun/urun-duzenle/".$this->urunListesi[$i]["urunId"]."' >Düzenle</a>
                    </li>
                    <li class='btnSil'>
                    <a>Sil</a>
                    </li>
  ...
  <script src="<?php echo $this->yolHtml ?>views/birimler/urunler/urun-listesi/urun-listesi.js"></script>
