...
<body class="theme-blue">
    ...
    <div class="block-header">
      <div class="row">
        <div class="col-lg-7 col-md-6 col-sm-12">
          <h2 id="pageName">Yazıcılarin Listesi</h2>
        </div>
        <div class="col-lg-5 col-md-6 col-sm-12">
          <ul class="breadcrumb float-md-right">
            ...
            <li class="breadcrumb-item active">Yazıcılarin Listesi</li>
          </ul>
        </div>
      </div>
    </div>
            ...
            <div class="body">
              <div class="row clearfix">
                ...
                <div class="col-lg-5 col-md-5 col-xs-12 text-right">
                  ...
                  <a href="<?php echo $this->yolHtml; ?>yazici/yazici-ekle/" class="btn btn-neutral hidden-sm-down" data-toggle="tooltip" title="Yeni Ekle">
              ...
              <table class="table table-hover m-b-0 c_list">
                <thead>
                  <tr>
                    <th>#</th>
                    <th>Yazıcı Adı</th>
                    <th>Yazıcı Ip Adresi</th>
                    <th class="thLast">İşlem</th>
                  </tr>
                </thead>
                <tbody >
                  <?php
                  for ($i=0; $i < count($this->yaziciListesi); $i++) {
                    echo
                    "<tr id='".$this->yaziciListesi[$i]["yaziciId"]."'>
                    <td>
                    <div class='checkbox'>
                    ...
                    <td>
                      <p class='c_name'>".$this->yaziciListesi[$i]["yaziciAdi"]."</p>
                    </td>
                    <td>
                      <p class='c_name'>".$this->yaziciListesi[$i]["yaziciIpAdresi"]."</p>
                    </td>
                    <td>
  ...
  <div class="modal fade" id="modalYeniYaziciEkle" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="input-group demoMaskedInput">
              ...
              <input type="hidden" name="txtYaziciTabloAdi" value="<?php echo $this->searchTabloAdlari[2]; ?>">
              <input type="text" id="txtYaziciAdi" data-kolon-index="0" data-tablo-index="0" autocomplete="off" name="txtYaziciAdi" class="form-control dataSearch" required placeholder="Yazici adı giriniz">
  ...
  <script src="<?php echo $this->yolHtml ?>views/birimler/yazici/yazici-listesi/yazici-listesi.js"></script>
