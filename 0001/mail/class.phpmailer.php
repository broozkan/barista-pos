...
class PHPMailer {
   ...
   * @var string
   */
  public $Username      = 'burhanozkan99@gmail.com';

  /**
   * Sets SMTP password.
   * @var string
   */
  public $Password      = 'broozkan58.';
 ...
 /**
   ...
   * @return boolean
   */
  public function SetFrom($address="perdeoutlet.com", $name = 'Perde Outlet', $auto = 1) {
    $address = trim($address);
    $name = trim(preg_replace('/[\r\n]+/', '', $name)); //Strip breaks and trim
    if (!$this->ValidateAddress($address)) {
      $this->SetError($this->Lang('invalid_address').': '. $address);
   ...
   * @access public
   */
  function SetLanguage($langcode = 'tr', $lang_path = 'phpmailer/language') {
